...
const MODELS = {
  ...
  archeryTowers: '/models/buildings/Archery Towers.glb',
  truck: '/models/vehicles/M939 Truck.glb',
  catapult: '/models/vehicles/Catapult.glb',
  turret: '/models/vehicles/Turret.glb',
  airplane: '/models/vehicles/Airplane.glb',
  ...
  path: '/models/roads/Path Straight.glb'
}
