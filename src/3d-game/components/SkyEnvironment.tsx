...
function SkyEnvironment() {
  const cloudModel = useGLTF('/models/environment/Cloud.glb')
  const cloudsModel = useGLTF('/models/environment/Clouds.glb')
  const sunModel = useGLTF('/models/environment/Sun.glb')
  const airplaneModel = useGLTF('/models/vehicles/Airplane.glb')
  const helicopterModel = useGLTF('/models/vehicles/Helicopter.glb')
