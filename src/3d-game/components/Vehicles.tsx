...
function Vehicles() {
  // Load vehicle models
  const truck = useGLTF('/models/vehicles/M939 Truck.glb')
  const catapult = useGLTF('/models/vehicles/Catapult.glb')
  const tank = useGLTF('/models/vehicles/Tank.glb')
  const turret = useGLTF('/models/vehicles/Turret.glb')
